...
function NavBar({props: {dropdown, open}}: NavBarProps) {
  ...
  return (
    ...
    <aside id="logo-sidebar" 
      className={`fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700
        ${dropdown.menu ? "translate-x-0": "-translate-x-full"}
      `}
    >
      ...
      <ul className="space-y-2 font-medium">
            ...
            <li>
                ...
                >
                      ...
                      <li>
                        <a href="#card" 
                          onClick={() => toggleContent('element-card')} 
                          className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                        >
                          Card
                        </a>
                      ...
                      <li>
                        <a href="#card-cut" 
                          onClick={() => toggleContent('element-card-cut')} 
                          className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                        >
                          Card Cut
                        </a>
            ...
            {/* WIP */}
            {/* <li>
                <a href="#plugins" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  ...
                  <span className="flex-1 ms-3 whitespace-nowrap">Plug-ins</span>
            ...
            <li>
                <a href="#login" onClick={() => toggleContent('log-in')} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="#signup" onClick={() => toggleContent('sign-up')} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
